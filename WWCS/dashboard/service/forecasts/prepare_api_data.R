...
forecast_6h.file <- file.path(ROOT_DIR, "WWCS/dashboard/service/forecasts/forecasts_6hourly_api.csv")
readr::write_delim(forecasts_6hourly, file = forecast_6h.file, delim = ",")

...
CREATE TABLE `submitted` (
  ...
  `data` varchar(400) DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=5135745 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='The data as submitted by the loggers';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-04-02 16:44:13
